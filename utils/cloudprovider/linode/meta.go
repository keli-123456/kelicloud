...
type providerConfig struct {
	Token string `json:"token" required:"false" help:"Legacy Linode Personal Access Token field. Use the token pool in the cloud panel for multi-token management."`
}
