...
var (
	ErrShareInvalidAccessPolicy = errors.New("invalid failover v2 share access policy")
	ErrShareNotFound            = errors.New("failover v2 share not found")
	ErrShareExpired             = errors.New("failover v2 share has expired")
	ErrShareConsumed            = errors.New("failover v2 share has already been used")
)
...
func IsShareExpired(share *models.FailoverV2Share, now time.Time) bool {
...
func IsShareConsumed(share *models.FailoverV2Share) bool {
	return share != nil && share.ConsumedAt != nil && !share.ConsumedAt.IsZero()
}

func ShareStatus(share *models.FailoverV2Share, now time.Time) string {
...
func ValidateSharePublicAccess(share *models.FailoverV2Share, now time.Time) error {
	if share == nil {
...
func ShouldConsumeShare(share *models.FailoverV2Share) bool {
	if share == nil {
		return false
	}
